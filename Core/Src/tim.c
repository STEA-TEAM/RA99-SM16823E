...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    */
    ...
    /* TIM4 DMA Init */
    /* TIM4_UP Init */
    hdma_tim4_up.Instance = DMA1_Channel3;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = PB1_TIM3_CH4_2811_2812_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(PB1_TIM3_CH4_2811_2812_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    PA6     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = PA6_TIM16_RA99_PWM1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM16;
    HAL_GPIO_Init(PA6_TIM16_RA99_PWM1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PA7     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = PA7_TIM17_RA99_PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM17;
    HAL_GPIO_Init(PA7_TIM17_RA99_PWM2_GPIO_Port, &GPIO_InitStruct);
